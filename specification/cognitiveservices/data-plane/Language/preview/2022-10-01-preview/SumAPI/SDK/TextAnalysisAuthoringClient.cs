...
{
    /// <summary> The TextAnalysisAuthoring service client. </summary>
    public partial class TextAnalysisAuthoringClient
    {
        ...
        public TextAnalysisAuthoringClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new MicrosoftCognitiveLanguageServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public TextAnalysisAuthoringClient(Uri endpoint, AzureKeyCredential credential, MicrosoftCognitiveLanguageServiceClientOptions options)
        {
        ...
        public virtual async Task<Response> CreateProjectAsync(string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.CreateProject");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetProjectAsync(string projectName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.GetProject");
            scope.Start();
            try
            {
        ...
        ///   deploymentExpirationDate: TextAnalysisAuthoringProjectDeploymentExpirationDate, # Required. Represents deployment expiration date in the runtime.
        ...
        public virtual async Task<Response> GetDeploymentAsync(string projectName, string deploymentName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.GetDeployment");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetDeploymentStatusAsync(string projectName, string deploymentName, string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.GetDeploymentStatus");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetSwapDeploymentsStatusAsync(string projectName, string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.GetSwapDeploymentsStatus");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetExportStatusAsync(string projectName, string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.GetExportStatus");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetImportStatusAsync(string projectName, string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.GetImportStatus");
            scope.Start();
            try
            {
        ...
        ///   modelExpirationDate: TextAnalysisAuthoringProjectTrainedModelExpirationDate, # Required. The model expiration date.
        ...
        public virtual async Task<Response> GetTrainedModelAsync(string projectName, string trainedModelLabel, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.GetTrainedModel");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteTrainedModelAsync(string projectName, string trainedModelLabel, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.DeleteTrainedModel");
            scope.Start();
            try
            {
        ...
        /// </code>
        /// </details>
        /// <details><summary>~+ 3 more JSON objects</summary><details><summary>CustomMultiLabelClassificationEvaluationSummary</summary>Schema for <c>CustomMultiLabelClassificationEvaluationSummary</c>:
        /// <code>{
        ...
        /// </code>
        /// </details>
        /// <details><summary>CustomAbstractiveSummarizationEvaluationSummary</summary>Schema for <c>CustomAbstractiveSummarizationEvaluationSummary</c>:
        /// <code>{
        ///   projectKind: CustomAbstractiveSummarization, # Required. Represents the project type that the evaluation ran on.
        ///   evaluationOptions: {
        ///     kind: &quot;percentage&quot; | &quot;manual&quot;, # Optional. Represents the evaluation kind. By default, the evaluation kind is set to percentage.
        ///     trainingSplitPercentage: number, # Optional. Represents the training dataset split percentage. Only needed in case the evaluation kind is percentage.
        ///     testingSplitPercentage: number, # Optional. Represents the testing dataset split percentage. Only needed in case the evaluation kind is percentage.
        ...
        ///   }, # Required. Contains the data related to abstractive summarization evaluation.
        /// }
        /// </code>
        /// </details>
        /// </details>
        ...
        public virtual async Task<Response> GetModelEvaluationSummaryAsync(string projectName, string trainedModelLabel, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.GetModelEvaluationSummary");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetTrainingStatusAsync(string projectName, string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.GetTrainingStatus");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetProjectDeletionStatusAsync(string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.GetProjectDeletionStatus");
            scope.Start();
            try
            {
        ...
        {
            return GetProjectsImplementationAsync("TextAnalysisAuthoringClient.GetProjects", top, skip, maxpagesize, context);
        }
        ...
        {
            return GetProjectsImplementation("TextAnalysisAuthoringClient.GetProjects", top, skip, maxpagesize, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetDeploymentsAsync(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetDeploymentsImplementationAsync("TextAnalysisAuthoringClient.GetDeployments", projectName, top, skip, maxpagesize, context);
        }
        ...
        public virtual Pageable<BinaryData> GetDeployments(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetDeploymentsImplementation("TextAnalysisAuthoringClient.GetDeployments", projectName, top, skip, maxpagesize, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetTrainedModelsAsync(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainedModelsImplementationAsync("TextAnalysisAuthoringClient.GetTrainedModels", projectName, top, skip, maxpagesize, context);
        }
        ...
        public virtual Pageable<BinaryData> GetTrainedModels(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainedModelsImplementation("TextAnalysisAuthoringClient.GetTrainedModels", projectName, top, skip, maxpagesize, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetModelEvaluationResultsAsync(string projectName, string trainedModelLabel, string stringIndexType, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetModelEvaluationResultsImplementationAsync("TextAnalysisAuthoringClient.GetModelEvaluationResults", projectName, trainedModelLabel, stringIndexType, top, skip, maxpagesize, context);
        }
        ...
        public virtual Pageable<BinaryData> GetModelEvaluationResults(string projectName, string trainedModelLabel, string stringIndexType, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetModelEvaluationResultsImplementation("TextAnalysisAuthoringClient.GetModelEvaluationResults", projectName, trainedModelLabel, stringIndexType, top, skip, maxpagesize, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetTrainingJobsAsync(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainingJobsImplementationAsync("TextAnalysisAuthoringClient.GetTrainingJobs", projectName, top, skip, maxpagesize, context);
        }
        ...
        public virtual Pageable<BinaryData> GetTrainingJobs(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainingJobsImplementation("TextAnalysisAuthoringClient.GetTrainingJobs", projectName, top, skip, maxpagesize, context);
        }
        ...
        {
            return GetSupportedLanguagesImplementationAsync("TextAnalysisAuthoringClient.GetSupportedLanguages", top, skip, maxpagesize, context);
        }
        ...
        {
            return GetSupportedLanguagesImplementation("TextAnalysisAuthoringClient.GetSupportedLanguages", top, skip, maxpagesize, context);
        }
        ...
        ///   modelExpirationDate: TextAnalysisAuthoringTrainingConfigVersionModelExpirationDate, # Required. Represents the training config version expiration date.
        /// }
        /// </code>
        /// 
        /// </remarks>
        public virtual AsyncPageable<BinaryData> GetTrainingConfigVersionsAsync(string projectKind, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainingConfigVersionsImplementationAsync("TextAnalysisAuthoringClient.GetTrainingConfigVersions", projectKind, top, skip, maxpagesize, context);
        }
        ...
        public virtual Pageable<BinaryData> GetTrainingConfigVersions(string projectKind, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainingConfigVersionsImplementation("TextAnalysisAuthoringClient.GetTrainingConfigVersions", projectKind, top, skip, maxpagesize, context);
        }
        ...
        public virtual async Task<Operation> DeleteProjectAsync(WaitUntil waitUntil, string projectName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.DeleteProject");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteProjectRequest(projectName, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.DeleteProject", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation DeleteProject(WaitUntil waitUntil, string projectName, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateDeleteProjectRequest(projectName, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.DeleteProject", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        public virtual async Task<Operation> ExportAsync(WaitUntil waitUntil, string projectName, string stringIndexType, string assetKind = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
            Argument.AssertNotNull(stringIndexType, nameof(stringIndexType));

            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.Export");
            scope.Start();
            try
            {
                using HttpMessage message = CreateExportRequest(projectName, stringIndexType, assetKind, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.Export", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        public virtual Operation Export(WaitUntil waitUntil, string projectName, string stringIndexType, string assetKind = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
            Argument.AssertNotNull(stringIndexType, nameof(stringIndexType));
            ...
            {
                using HttpMessage message = CreateExportRequest(projectName, stringIndexType, assetKind, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.Export", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// 
        /// </remarks>
        public virtual async Task<Operation> ImportAsync(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.Import");
            scope.Start();
            try
            {
                using HttpMessage message = CreateImportRequest(projectName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.Import", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// 
        /// </remarks>
        public virtual Operation Import(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
            Argument.AssertNotNull(content, nameof(content));
            ...
            {
                using HttpMessage message = CreateImportRequest(projectName, content, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.Import", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> TrainAsync(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.Train");
            scope.Start();
            try
            {
                using HttpMessage message = CreateTrainRequest(projectName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.Train", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation Train(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateTrainRequest(projectName, content, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.Train", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> SwapDeploymentsAsync(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.SwapDeployments");
            scope.Start();
            try
            {
                using HttpMessage message = CreateSwapDeploymentsRequest(projectName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.SwapDeployments", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation SwapDeployments(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateSwapDeploymentsRequest(projectName, content, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.SwapDeployments", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> DeployProjectAsync(WaitUntil waitUntil, string projectName, string deploymentName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.DeployProject");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeployProjectRequest(projectName, deploymentName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.DeployProject", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation DeployProject(WaitUntil waitUntil, string projectName, string deploymentName, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateDeployProjectRequest(projectName, deploymentName, content, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.DeployProject", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> DeleteDeploymentAsync(WaitUntil waitUntil, string projectName, string deploymentName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.DeleteDeployment");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteDeploymentRequest(projectName, deploymentName, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.DeleteDeployment", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation DeleteDeployment(WaitUntil waitUntil, string projectName, string deploymentName, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateDeleteDeploymentRequest(projectName, deploymentName, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.DeleteDeployment", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> CancelTrainingJobAsync(WaitUntil waitUntil, string projectName, string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("TextAnalysisAuthoringClient.CancelTrainingJob");
            scope.Start();
            try
            {
                using HttpMessage message = CreateCancelTrainingJobRequest(projectName, jobId, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.CancelTrainingJob", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation CancelTrainingJob(WaitUntil waitUntil, string projectName, string jobId, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateCancelTrainingJobRequest(projectName, jobId, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "TextAnalysisAuthoringClient.CancelTrainingJob", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        internal HttpMessage CreateExportRequest(string projectName, string stringIndexType, string assetKind, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier202);
            var request = message.Request;
        ...
        internal HttpMessage CreateImportRequest(string projectName, RequestContent content, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier202);
            var request = message.Request;
            request.Method = RequestMethod.Post;
