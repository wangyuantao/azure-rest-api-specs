...
namespace MicrosoftCognitiveLanguageService
{
    ...
    public partial class MicrosoftCognitiveLanguageServiceClient
    {
        ...
        public MicrosoftCognitiveLanguageServiceClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new MicrosoftCognitiveLanguageServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public MicrosoftCognitiveLanguageServiceClient(Uri endpoint, AzureKeyCredential credential, MicrosoftCognitiveLanguageServiceClientOptions options)
        {
        ...
        ///     stringIndexType: &quot;Utf16CodeUnit&quot;, # Optional.
        ...
        ///   detectedLanguage: string, # Optional. If &apos;language&apos; is set to &apos;auto&apos; for the document in the request this field will contain a 2 letter ISO 639-1 representation of the language detected for this document.
        ///   results: {
        ///     errors: [
        ///       {
        ...
        ///         }, # Required. Error encountered.
        ///       }
        ///     ], # Required. Errors by document id or conversation id.
        ///     statistics: {
        ...
        ///         confidenceScores: {
        ///           positive: number, # Required. Confidence score for positive sentiment
        ///           neutral: number, # Required. Confidence score for neutral sentiment
        ///           negative: number, # Required. Confidence score for negative sentiment
