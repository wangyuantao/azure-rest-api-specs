...
{
    /// <summary> The ConversationalAnalysisAuthoring service client. </summary>
    public partial class ConversationalAnalysisAuthoringClient
    {
        ...
        /// <summary> Initializes a new instance of ConversationalAnalysisAuthoringClient for mocking. </summary>
        protected ConversationalAnalysisAuthoringClient()
        {
        }

        /// <summary> Initializes a new instance of ConversationalAnalysisAuthoringClient. </summary>
        /// <param name="endpoint"> Supported Cognitive Services endpoint (e.g., https://&lt;resource-name&gt;.api.cognitiveservices.azure.com). </param>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ConversationalAnalysisAuthoringClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new MicrosoftCognitiveLanguageServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ConversationalAnalysisAuthoringClient(Uri endpoint, AzureKeyCredential credential, MicrosoftCognitiveLanguageServiceClientOptions options)
        {
        ...
        /// Request Body:
        /// 
        /// Schema for <c>CreateProjectOptionsAutoGenerated</c>:
        /// <code>{
        ...
        /// Response Body:
        /// 
        /// Schema for <c>ProjectMetadataAutoGenerated</c>:
        /// <code>{
        ...
        public virtual async Task<Response> CreateProjectAsync(string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.CreateProject");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetProjectAsync(string projectName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.GetProject");
            scope.Start();
            try
            {
        ...
        /// Response Body:
        /// 
        /// Schema for <c>ProjectDeploymentAutoGenerated</c>:
        /// <code>{
        ...
        public virtual async Task<Response> GetDeploymentAsync(string projectName, string deploymentName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.GetDeployment");
            scope.Start();
            try
            {
        ...
        /// Response Body:
        /// 
        /// Schema for <c>DeploymentJobStateAutoGenerated</c>:
        /// <code>{
        ...
        public virtual async Task<Response> GetDeploymentStatusAsync(string projectName, string deploymentName, string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.GetDeploymentStatus");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> GetSwapDeploymentsStatusAsync(string projectName, string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.GetSwapDeploymentsStatus");
            scope.Start();
            try
            {
        ...
        /// Response Body:
        /// 
        /// Schema for <c>ExportProjectJobStateAutoGenerated</c>:
        /// <code>{
        ///   jobId: string, # Required. The job ID.
        ///   createdDateTime: string (ISO 8601 Format), # Required. The creation date time of the job.
        ///   lastUpdatedDateTime: string (ISO 8601 Format), # Required. The last date time the job was updated.
        ...
        public virtual async Task<Response> GetExportStatusAsync(string projectName, string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.GetExportStatus");
            scope.Start();
            try
            {
        ...
        /// Response Body:
        /// 
        /// Schema for <c>ImportProjectJobStateAutoGenerated</c>:
        /// <code>{
        ///   jobId: string, # Required. The job ID.
        ///   createdDateTime: string (ISO 8601 Format), # Required. The creation date time of the job.
        ///   lastUpdatedDateTime: string (ISO 8601 Format), # Required. The last date time the job was updated.
        ...
        public virtual async Task<Response> GetImportStatusAsync(string projectName, string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.GetImportStatus");
            scope.Start();
            try
            {
        ...
        /// Response Body:
        /// 
        /// Schema for <c>ProjectTrainedModelAutoGenerated</c>:
        /// <code>{
        ...
        public virtual async Task<Response> GetTrainedModelAsync(string projectName, string trainedModelLabel, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.GetTrainedModel");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteTrainedModelAsync(string projectName, string trainedModelLabel, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.DeleteTrainedModel");
            scope.Start();
            try
            {
        ...
        /// <details><summary>EvaluationSummaryAutoGenerated</summary>Schema for <c>EvaluationSummaryAutoGenerated</c>:
        /// <code>{
        ///   projectKind: Conversation, # Required. Represents the project type that the evaluation ran on.
        ///   entitiesEvaluation: {
        ///     confusionMatrix: Dictionary&lt;string, Dictionary&lt;string, ConfusionMatrixCellAutoGenerated&gt;&gt;, # Required. Represents the confusion matrix between two entities (the two entities can be the same). The matrix is between the entity that was labelled and the entity that was predicted.
        ///     entities: Dictionary&lt;string, EntityEvaluationSummaryAutoGenerated&gt;, # Required. Represents the entities evaluation summary.
        ...
        ///   intentsEvaluation: {
        ///     confusionMatrix: Dictionary&lt;string, Dictionary&lt;string, ConfusionMatrixCellAutoGenerated&gt;&gt;, # Required. Represents the confusion matrix between two intents (the two intents can be the same). The matrix is between the intent that was labelled and the intent that was predicted.
        ...
        /// </code>
        /// </details>
        /// <details><summary>~+ 1 more JSON objects</summary><details><summary>ConversationalAnalysisAuthoringSummarizationEvaluationSummary</summary>Schema for <c>ConversationalAnalysisAuthoringSummarizationEvaluationSummary</c>:
        /// <code>{
        ///   projectKind: ConversationSummarization, # Required. Represents the project type that the evaluation ran on.
        ///   summarizationEvaluation: {
        ///     rouge1: number, # Required. Represents the ROUGE-1 F1
        ///     rouge2: number, # Required. Represents the ROUGE-2 F1
        ///     rougeL: number, # Required. Represents the ROUGE-L F1
        ///     bleu: number, # Required. Represents the score of bilingual evaluation understudy
        ///     chrF: number, # Required. Represents the character n-gram F-score
        ///     bertScore: number, # Required. Represents the Bert score
        ///   }, # Required. Contains the data related to conversation summarization evaluation.
        /// }
        /// </code>
        /// </details>
        /// </details>
        ...
        public virtual async Task<Response> GetModelEvaluationSummaryAsync(string projectName, string trainedModelLabel, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.GetModelEvaluationSummary");
            scope.Start();
            try
            {
        ...
        /// Response Body:
        /// 
        /// Schema for <c>TrainingJobStateAutoGenerated</c>:
        /// <code>{
        ///   jobId: string, # Required. The job ID.
        ///   createdDateTime: string (ISO 8601 Format), # Required. The creation date time of the job.
        ///   lastUpdatedDateTime: string (ISO 8601 Format), # Required. The last date time the job was updated.
        ...
        ///     evaluationStatus: SubTrainingJobStateAutoGenerated, # Optional. Represents model evaluation status.
        ...
        public virtual async Task<Response> GetTrainingStatusAsync(string projectName, string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.GetTrainingStatus");
            scope.Start();
            try
            {
        ...
        /// Response Body:
        /// 
        /// Schema for <c>ProjectDeletionJobStateAutoGenerated</c>:
        /// <code>{
        ///   jobId: string, # Required. The job ID.
        ///   createdDateTime: string (ISO 8601 Format), # Required. The creation date time of the job.
        ///   lastUpdatedDateTime: string (ISO 8601 Format), # Required. The last date time the job was updated.
        ...
        public virtual async Task<Response> GetProjectDeletionStatusAsync(string jobId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.GetProjectDeletionStatus");
            scope.Start();
            try
            {
        ...
        {
            return GetProjectsImplementationAsync("ConversationalAnalysisAuthoringClient.GetProjects", top, skip, maxpagesize, context);
        }
        ...
        {
            return GetProjectsImplementation("ConversationalAnalysisAuthoringClient.GetProjects", top, skip, maxpagesize, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetDeploymentsAsync(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetDeploymentsImplementationAsync("ConversationalAnalysisAuthoringClient.GetDeployments", projectName, top, skip, maxpagesize, context);
        }
        ...
        public virtual Pageable<BinaryData> GetDeployments(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetDeploymentsImplementation("ConversationalAnalysisAuthoringClient.GetDeployments", projectName, top, skip, maxpagesize, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetTrainedModelsAsync(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainedModelsImplementationAsync("ConversationalAnalysisAuthoringClient.GetTrainedModels", projectName, top, skip, maxpagesize, context);
        }
        ...
        public virtual Pageable<BinaryData> GetTrainedModels(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainedModelsImplementation("ConversationalAnalysisAuthoringClient.GetTrainedModels", projectName, top, skip, maxpagesize, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetModelEvaluationResultsAsync(string projectName, string trainedModelLabel, string stringIndexType, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetModelEvaluationResultsImplementationAsync("ConversationalAnalysisAuthoringClient.GetModelEvaluationResults", projectName, trainedModelLabel, stringIndexType, top, skip, maxpagesize, context);
        }
        ...
        public virtual Pageable<BinaryData> GetModelEvaluationResults(string projectName, string trainedModelLabel, string stringIndexType, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetModelEvaluationResultsImplementation("ConversationalAnalysisAuthoringClient.GetModelEvaluationResults", projectName, trainedModelLabel, stringIndexType, top, skip, maxpagesize, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetTrainingJobsAsync(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainingJobsImplementationAsync("ConversationalAnalysisAuthoringClient.GetTrainingJobs", projectName, top, skip, maxpagesize, context);
        }
        ...
        public virtual Pageable<BinaryData> GetTrainingJobs(string projectName, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainingJobsImplementation("ConversationalAnalysisAuthoringClient.GetTrainingJobs", projectName, top, skip, maxpagesize, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetSupportedLanguagesAsync(string projectKind, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetSupportedLanguagesImplementationAsync("ConversationalAnalysisAuthoringClient.GetSupportedLanguages", projectKind, top, skip, maxpagesize, context);
        }
        ...
        public virtual Pageable<BinaryData> GetSupportedLanguages(string projectKind, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetSupportedLanguagesImplementation("ConversationalAnalysisAuthoringClient.GetSupportedLanguages", projectKind, top, skip, maxpagesize, context);
        }
        ...
        {
            return GetSupportedPrebuiltEntitiesImplementationAsync("ConversationalAnalysisAuthoringClient.GetSupportedPrebuiltEntities", language, multilingual, top, skip, maxpagesize, context);
        }
        ...
        {
            return GetSupportedPrebuiltEntitiesImplementation("ConversationalAnalysisAuthoringClient.GetSupportedPrebuiltEntities", language, multilingual, top, skip, maxpagesize, context);
        }
        ...
        public virtual AsyncPageable<BinaryData> GetTrainingConfigVersionsAsync(string projectKind, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainingConfigVersionsImplementationAsync("ConversationalAnalysisAuthoringClient.GetTrainingConfigVersions", projectKind, top, skip, maxpagesize, context);
        }
        ...
        public virtual Pageable<BinaryData> GetTrainingConfigVersions(string projectKind, int? top = null, int? skip = null, int? maxpagesize = null, RequestContext context = null)
        {
            ...
            return GetTrainingConfigVersionsImplementation("ConversationalAnalysisAuthoringClient.GetTrainingConfigVersions", projectKind, top, skip, maxpagesize, context);
        }
        ...
        public virtual async Task<Operation> DeleteProjectAsync(WaitUntil waitUntil, string projectName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.DeleteProject");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteProjectRequest(projectName, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.DeleteProject", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation DeleteProject(WaitUntil waitUntil, string projectName, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateDeleteProjectRequest(projectName, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.DeleteProject", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        public virtual async Task<Operation> ExportAsync(WaitUntil waitUntil, string projectName, string stringIndexType, string exportedProjectFormat = null, string assetKind = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
            Argument.AssertNotNull(stringIndexType, nameof(stringIndexType));

            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.Export");
            scope.Start();
            try
            {
                using HttpMessage message = CreateExportRequest(projectName, stringIndexType, exportedProjectFormat, assetKind, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.Export", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        public virtual Operation Export(WaitUntil waitUntil, string projectName, string stringIndexType, string exportedProjectFormat = null, string assetKind = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
            Argument.AssertNotNull(stringIndexType, nameof(stringIndexType));
            ...
            {
                using HttpMessage message = CreateExportRequest(projectName, stringIndexType, exportedProjectFormat, assetKind, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.Export", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// Request Body:
        /// 
        /// Schema for <c>ExportedProjectAutoGenerated</c>:
        /// <code>{
        ...
        ///   assets: {
        ///     projectKind: &quot;CustomSingleLabelClassification&quot; | &quot;CustomMultiLabelClassification&quot; | &quot;CustomEntityRecognition&quot; | &quot;CustomAbstractiveSummarization&quot;, # Required. The type of project containing the assets.
        ...
        public virtual async Task<Operation> ImportAsync(WaitUntil waitUntil, string projectName, RequestContent content, string exportedProjectFormat = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.Import");
            scope.Start();
            try
            {
                using HttpMessage message = CreateImportRequest(projectName, content, exportedProjectFormat, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.Import", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation Import(WaitUntil waitUntil, string projectName, RequestContent content, string exportedProjectFormat = null, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateImportRequest(projectName, content, exportedProjectFormat, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.Import", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// Request Body:
        /// 
        /// Schema for <c>TrainingJobOptionsAutoGenerated</c>:
        /// <code>{
        ...
        public virtual async Task<Operation> TrainAsync(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.Train");
            scope.Start();
            try
            {
                using HttpMessage message = CreateTrainRequest(projectName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.Train", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation Train(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateTrainRequest(projectName, content, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.Train", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// Request Body:
        /// 
        /// Schema for <c>SwapDeploymentsOptionsAutoGenerated</c>:
        /// <code>{
        ...
        public virtual async Task<Operation> SwapDeploymentsAsync(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.SwapDeployments");
            scope.Start();
            try
            {
                using HttpMessage message = CreateSwapDeploymentsRequest(projectName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.SwapDeployments", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation SwapDeployments(WaitUntil waitUntil, string projectName, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateSwapDeploymentsRequest(projectName, content, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.SwapDeployments", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// Request Body:
        /// 
        /// Schema for <c>CreateDeploymentOptionsAutoGenerated</c>:
        /// <code>{
        ...
        public virtual async Task<Operation> DeployProjectAsync(WaitUntil waitUntil, string projectName, string deploymentName, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.DeployProject");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeployProjectRequest(projectName, deploymentName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.DeployProject", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation DeployProject(WaitUntil waitUntil, string projectName, string deploymentName, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateDeployProjectRequest(projectName, deploymentName, content, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.DeployProject", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation> DeleteDeploymentAsync(WaitUntil waitUntil, string projectName, string deploymentName, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.DeleteDeployment");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDeleteDeploymentRequest(projectName, deploymentName, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.DeleteDeployment", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation DeleteDeployment(WaitUntil waitUntil, string projectName, string deploymentName, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateDeleteDeploymentRequest(projectName, deploymentName, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.DeleteDeployment", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        public virtual async Task<Operation> CancelTrainingJobAsync(WaitUntil waitUntil, string projectName, string jobId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
            Argument.AssertNotNullOrEmpty(jobId, nameof(jobId));

            using var scope = ClientDiagnostics.CreateScope("ConversationalAnalysisAuthoringClient.CancelTrainingJob");
            scope.Start();
            try
            {
                using HttpMessage message = CreateCancelTrainingJobRequest(projectName, jobId, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.CancelTrainingJob", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        public virtual Operation CancelTrainingJob(WaitUntil waitUntil, string projectName, string jobId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(projectName, nameof(projectName));
            Argument.AssertNotNullOrEmpty(jobId, nameof(jobId));
            ...
            {
                using HttpMessage message = CreateCancelTrainingJobRequest(projectName, jobId, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "ConversationalAnalysisAuthoringClient.CancelTrainingJob", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
