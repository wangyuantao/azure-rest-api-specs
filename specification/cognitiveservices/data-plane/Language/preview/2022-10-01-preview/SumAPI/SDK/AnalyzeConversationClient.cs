...
namespace MicrosoftCognitiveLanguageService
{
    ...
    public partial class AnalyzeConversationClient
    {
        ...
        public AnalyzeConversationClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new MicrosoftCognitiveLanguageServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public AnalyzeConversationClient(Uri endpoint, AzureKeyCredential credential, MicrosoftCognitiveLanguageServiceClientOptions options)
        {
        ...
        ///         kind: &quot;ConversationalPIIResults&quot; | &quot;ConversationalSummarizationResults&quot; | &quot;CustomConversationalSummarizationResults&quot;, # Required. Enumeration of supported Conversation Analysis task results.
        ///       }
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("AnalyzeConversationClient.JobStatus");
            scope.Start();
            try
            {
        ...
        ///     {
        ///       taskName: string, # Optional.
        ///       kind: &quot;ConversationalPIITask&quot; | &quot;ConversationalSummarizationTask&quot; | &quot;CustomConversationalSummarizationTask&quot;, # Required. Enumeration of supported analysis tasks on a collection of conversations.
        ///     }
        ...
        public virtual async Task<Operation> SubmitJobAsync(WaitUntil waitUntil, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("AnalyzeConversationClient.SubmitJob");
            scope.Start();
            try
            {
                using HttpMessage message = CreateSubmitJobRequest(content, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "AnalyzeConversationClient.SubmitJob", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation SubmitJob(WaitUntil waitUntil, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateSubmitJobRequest(content, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "AnalyzeConversationClient.SubmitJob", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
